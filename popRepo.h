...
class PopRepo{
 private:
  ...
  string footnote;
 public:
  inline PopRepo():name(),title("Report"),header(),footnote(){};
  inline PopRepo(string t,string h,string f):name(),title(t),header(h),footnote(f){};


  void print(simulation::Population& pop,simulation::Parameters& par);
