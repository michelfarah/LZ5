...
#ifndef __SPECSTRUCTURES_H__
#define __SPECSTRUCTURES_H__
  
struct pairId{
  unsigned iId;                            //individual id
  unsigned short gId;                      //generation id
  
  inline pairId():iId(0),gId(0){};        
};
...
struct triplet{                             //used for selection purposes
  unsigned iId;
  unsigned gId;
  double sc;                               //selection criterion
};  
