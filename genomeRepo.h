...
#ifndef __GENOM_REPO__
#define __GENOM_REPO__
...
class GenomeRepo{
 private:
  ...
  string footnote;
 public:
  inline GenomeRepo():name(),title("Report"),header(),footnote(){};
  inline GenomeRepo(string t,string h,string f):name(),title(t),header(h),footnote(f){};


  void print(simulation::Parameters& par);
