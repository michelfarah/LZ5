...
namespace report{
  ...
  //void IndSelRepo::print(selection::IndSel& iSel,simulation::Parameters& par){
  
//}

  //void IndSelRepo::exec(lz5_Result_Struct& e,selection::IndSel& iSel, simulation::Parameters& par){
    //if(e.object!=getName())return;
    //if(e.method=="iSelRepo"){
      //print(iSel,par);
    //}
  //}
